  ...
  <div class="container mt-4 mt-md-7">
    <div class="row align-items-center">
      <div class="col-lg-6">
        ...
        <h4>
          Do you want to ba a talent on
          <h2 class="text-bottle d-inline-block">Dzicace?</h2>
        </h4>
        <p class="text-bottle fw-bold mt-3">
          The only place where you can share happiness! Share your fans their
          special moments with funny, heartwarming and joyful videos
        </p>
      </div>
          ...
          <div class="row">
            <div class="col-lg-4 px-3 mt-lg-0 mt-3">
              ...
              <p class="mt-4 fw-bold">
                30 seconds is all it takes, so wherever you are, a video to your
                fans is always an option! Dzicace can be done anytime, anywhere,
            ...
            <div class="col-lg-4 px-3 mt-lg-0 mt-3">
              ...
              <p class="mt-4 fw-bold">
                Searching for real connection? Be part of your fans' special
                occasions and share the joy of all moments, Dzicace makes this
                communication simpler than ever!
              </p>
            </div>
            <div class="col-lg-4 px-3 mt-lg-0 mt-3">
              <h4>
              ...
              <p class="mt-4 fw-bold">
                Are you seeking a noble sharing experience? Dzicace allows you
                to design your support experience with giving back your earnings
    ...
    <div class="row justify-content-center align-items-center mt-7">
      <div class="col-lg-5">
        ...
        <p class="fw-bold text-lg mt-3 text-bottle">
          In 4 days, you can accept or decline Fans Requests <br /><br />
    ...
    <div class="row align-items-center mt-8">
      ...
      <div class="col-lg-6">
        ...
        <p class="text-bottle fw-bold mt-3 text-lg" style="line-height: 3">
          If I'm priced at $<input
            type="text"
      ...
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">JOIN AS TALENT</h5>
            <button
              type="button"
              class="btn-close"
          ...
          <div class="modal-body">
            <p class="fw-bold">
              Join Dzicace as a talent today! Fill in the form and our team will
            ...
            <form @submit.prevent="joinTalent">
              ...
              <div class="mb-3">
                <input
                  ...
                  v-model="phoneNumber"
                />
                <span v-if="v$.phoneNumber.$error" class="text-sm text-danger">
              ...
              <div class="mb-3">
                ...
                />
                <span v-if="v$.social.$error" class="text-sm text-danger">
              ...
              <div class="mb-3">
                <input
                  ...
                  v-model="nickName"
                />
                <span v-if="v$.nickName.$error" class="text-sm text-danger">
              ...
              <div class="mb-3">
                <input
                  ...
                  v-model="socialLink"
                />
                <span v-if="v$.socialLink.$error" class="text-sm text-danger">
              ...
              <div class="mb-3">
                <textarea
                  ...
                  rows="4"
                ></textarea>
                <span v-if="v$.description.$error" class="text-sm text-danger">
...
export default {
  ...
  validations() {
    return {
      ...
      nickName: {
        required: helpers.withMessage("Please Enter Your Nick Name", required),
      },
      email: {
      ...
      description: {
        required: helpers.withMessage("Please Enter Your Bio", required),
      },
    };
  },
  methods: {
    async joinTalent() {
      ...
      try {
        ...
        await this.$store.dispatch("talent/talentJoin", {
          ...
          selectedCountary: this.selectedCountary,
