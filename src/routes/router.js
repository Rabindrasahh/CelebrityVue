...
const routes = [
    { path: "/", name: "index", component: TheIndex, meta: { Auth: false } },
    {
    ...
    { path: "/sign-up", name: "signup", component: TheSignup, meta: { Auth: false } },
    { path: "/login", name: "login", component: TheLogin, meta: { Auth: false } },
    { path: "/talents-join", name: "talentsJoin", component: TalentsJoin, meta: { Auth: false } },
    {
...
router.beforeEach(async (to, _, next) => {
    ...
    if (!isAuthenticated) {
        ...
        if (store.getters["auth/getUserRole"] === undefined) {
            ...
            if (role === "user" && (to.meta.Talent || to.meta.Admin)) return next("/");
